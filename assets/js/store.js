const PRODUCTS = [
  {id:'camiseta-sol-nascente',name:'Camiseta Sol Nascente',category:'Camisetas',categorySlug:'camisetas',description:'Algodão premium, modelagem ampla e estampa solar.',price:149.90,featured:true,image:'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=900&q=80'},
  {id:'camiseta-mata-atlantica',name:'Camiseta Mata Atlântica',category:'Camisetas',categorySlug:'camisetas',description:'Malha encorpada com tingimento verde profundo.',price:159.90,featured:true,image:'https://images.unsplash.com/photo-1503341504253-dff4815485f1?auto=format&fit=crop&w=900&q=80'},
  {id:'moletom-horizonte',name:'Moletom Horizonte',category:'Moletons',categorySlug:'moletons',description:'Moletom felpado oversized para noites tropicais.',price:329.90,featured:true,image:'https://images.unsplash.com/photo-1556821840-3a63f95609a7?auto=format&fit=crop&w=900&q=80'},
  {id:'calca-cargo-cerrado',name:'Calça Cargo Cerrado',category:'Calças',categorySlug:'calcas',description:'Sarja resistente e bolsos utilitários.',price:289.90,featured:true,image:'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?auto=format&fit=crop&w=900&q=80'},
  {id:'short-orla',name:'Short Orla',category:'Shorts',categorySlug:'shorts',description:'Leve, funcional e pronto para o calor.',price:189.90,featured:false,image:'https://images.unsplash.com/photo-1591195853828-11db59a44f6b?auto=format&fit=crop&w=900&q=80'},
